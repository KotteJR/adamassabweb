    ...
    return (
      <div className={`rounded-2xl bg-white shadow-lg border border-gray-200 overflow-hidden flex flex-col w-full`}>
        ...
        <div className="overflow-y-auto flex-grow min-h-0 max-h-[350px] sm:max-h-[450px] md:max-h-[550px] lg:max-h-[650px]">
          ...
          {/* Image Display Area */}
          {hasImage && (
            <div className="relative w-full bg-white p-1">
              <Image 
      ...
      <div className="max-w-7xl mx-auto py-16 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black mb-3 leading-tight text-center">
            Run your own automated desktop review.
          </h2>
          <p className="text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed text-center">
            Adamass Intelligence reflects how we analyze tech from the outside in — now available to everyone, free and open source.
          </p>
        </div>
